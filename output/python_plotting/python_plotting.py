...
plt.scatter(time[1:], avg_diff_pdot_bot[1:], color='g', s=150, label='average diff_pdot_bot')
plt.scatter(time[1:], avg_diff_pdot_top[1:], color='b', s=150, label='average diff_pdot_top')
plt.legend(fontsize=fs_-5)
...
plt.scatter(time[1:], avg_diff_mdot_bot[1:], color='g', s=150, label='average diff_mdot_bot')
plt.scatter(time[1:], avg_diff_mdot_top[1:], color='b', s=150, label='average diff_mdot_top')
plt.legend(fontsize=fs_-5)
...
plt.scatter(time[1:], avg_diff_m_bot[1:], color='g', s=150, label='average diff_M_bot')
plt.scatter(time[1:], avg_diff_m_top[1:], color='b', s=150, label='average diff_M_top')
plt.legend(fontsize=fs_-5)
...
plt.scatter(time[1:], avg_diff_theta_bot[1:], color='g', s=150, label='average diff_theta_bot')
plt.scatter(time[1:], avg_diff_theta_top[1:], color='b', s=150, label='average diff_theta_top')
plt.legend(fontsize=fs_-5)
